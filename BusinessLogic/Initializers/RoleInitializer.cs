...
public class RoleInitializer(IRolesRepository roleRepository,IPermissionsRepository permissionsRepository,IAccountLogic accountLogic,
             IUserRepository userRepository): BaseInitializer
{
    ...
    protected override void Initialize()
    {
        ...
        if (!roleRepository.GetAll().Any())
        {
            ...
            var user = new Role { Name = RoleNames.User.ToString() };
            roleRepository.Insert(user).Wait();
            ...
            foreach (var permission in permissions)
            {
                ...
                permissionsRepository.AssignPermissionToRole(permObj.Id, user.Id);
            }
        }
        ...
        accountLogic.Register(new UserAuthenticationRequest { Title="Mrs",FirstName="Anamika",LastName="Poudel",UserName = "Admin", Password = "123123123" },
            "Admin");
    }
}