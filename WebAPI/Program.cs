...
services.AddIdentity<IdentityUser, IdentityRole>(options =>
{
   ...
   .AddEntityFrameworkStores<ApplicationDbContext>().AddDefaultTokenProviders(); // Replace with your DbContext
...
//services.AddTransient<SmtpClient>(provider => new SmtpClient("smtp.example.com") // Configure your SMTP settings here
//{
//    Port = 587,
